package com.example.springboot.guava.ratelimiter.controller;
...
public class ProductController {
    ...
    @RateLimit(name = "测试限流每秒2个请求", perSecond = 1)
    public ResponseEntity<List<ProductEntity>> queryProducts(@RequestParam("productCode") Integer productCode){
        ...
        System.out.println("匹配到符合相应productCode的商品信息为 =" + JSONObject.toJSONString(matchProducts));
